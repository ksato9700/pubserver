(function() {
  var AdmZip, GridStore, MongoClient, api_root, app, bodyParser, check_archive, compression, content_type, express, fs, get_from_gs, get_zipped, methodOverride, mongo_url, mongodb, mongodb_credential, mongodb_host, mongodb_port, morgan, multer, repo_backend, request, upload, upload_content, upload_content_data, version, yaml, zlib;
